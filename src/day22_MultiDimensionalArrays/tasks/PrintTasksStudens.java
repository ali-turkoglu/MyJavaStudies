...
public class PrintTasksStudens {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < batch24Groups.length; i++) {
            cydeoStudents[i]=batch24Groups[i];

        }
        for (int i = 0; i < batch25Groups.length; i++) {
            cydeoStudents[(batch24Groups.length)+i]=batch25Groups[i];

        }
        //System.out.println(Arrays.deepToString(cydeoStudents));
        System.out.println("25:"+Arrays.deepToString(batch25Groups));
        System.out.println("24:"+Arrays.deepToString(batch24Groups));
        System.out.println("cydeo:"+Arrays.deepToString(cydeoStudents));
        System.out.println("------------------------------------------------------------------");
        ...
        /*for (int i = 0; i < batch25Groups.length; i++) {
            for (int j = 0; j < batch25Groups.length; j++) {
                batch25Groups[i][j]=batch24Groups[i][j];
            }
        }*/
