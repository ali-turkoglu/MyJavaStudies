...
public class MapPractice {
    ...
    public static void main(String[] args) {
        ...
        String topicNameOfMin="";
        for (Map<String, Double> eachUnit : allUnits) {

            for (Map.Entry<String, Double> e : eachUnit.entrySet()) {
                if (e.getValue()>max){
                    max=e.getValue();
                    topicName= e.getKey();
                }
                if (e.getValue()<min){
                    min=e.getValue();
                    topicNameOfMin=e.getKey();
                }
            }
        }
        System.out.println(topicName+" : "+max);
        System.out.println(topicNameOfMin+" : "+min);
