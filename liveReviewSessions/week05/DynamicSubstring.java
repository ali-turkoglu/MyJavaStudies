...
public class DynamicSubstring {
    public static void main(String[] args) {
        ...
        System.out.println(searchResult2.substring(searchResult2.lastIndexOf(":")+1));
        System.out.println(searchResult2.substring(searchResult2.indexOf(":",searchResult2.indexOf(":")+1)));

        System.out.println(searchResult2.indexOf(":",searchResult2.indexOf(":")+1));
        System.out.println(searchResult2.substring(36));
